...
import '../../data/models/agent_category_model.dart';
import '../../../../../shared/constants/app_routes.dart';

class AgentProfileCategoriesPage extends StatefulWidget {
  final Map<String, dynamic> profileData;

  const AgentProfileCategoriesPage({
    super.key,
    required this.profileData,
  });

  @override
  State<AgentProfileCategoriesPage> createState() => _AgentProfileCategoriesPageState();
}

class _AgentProfileCategoriesPageState extends State<AgentProfileCategoriesPage> {
                ...
                child: ElevatedButton(
                  onPressed: _selectedCategories.isNotEmpty
                      ? () {
                          ...
                          updatedData['categories'] = _selectedCategories.map((c) => c.id).toList();
                          
                          Navigator.pushNamed(
                            context,
                            AppRoutes.agentProfileBrands,
