...
class AgentProfileEmailPage extends StatefulWidget {
  const AgentProfileEmailPage({super.key});

  @override
  State<AgentProfileEmailPage> createState() => _AgentProfileEmailPageState();
}

class _AgentProfileEmailPageState extends State<AgentProfileEmailPage> with TickerProviderStateMixin {
