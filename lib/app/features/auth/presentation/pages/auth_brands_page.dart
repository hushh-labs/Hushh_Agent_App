...
import '../../../agent_profile/domain/entities/agent_brand.dart';
import '../../../agent_profile/data/models/agent_brand_model.dart';
import '../../../../../shared/constants/app_routes.dart';

class AuthBrandsPage extends StatefulWidget {
  final Map<String, dynamic> profileData;

  const AuthBrandsPage({
    super.key,
    required this.profileData,
  });

  @override
  State<AuthBrandsPage> createState() => _AuthBrandsPageState();
}

class _AuthBrandsPageState extends State<AuthBrandsPage> {
